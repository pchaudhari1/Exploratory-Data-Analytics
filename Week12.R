...
# Create model of non-constant variance
set.seed(42)
sim_data_2 = sim_2()
...
# Create a model which does not meet the linearity assumption
set.seed(42)
sim_data_3 = sim_3()
...
#Histograms
#Histogram to assess normality assumption
par(mfrow = c(1, 3))
hist(resid(fit_1),
     xlab   = "Residuals",
...
qq_plot = function(e) {
  ...
  # plot theoretical quantiles verus the  observed quantiles
  ...
  # calculating line through first and third quartiles
...
# Checking for low leverage, large residual, small influence
point_1 = c(5.4, 11)
...
# Checking for high leverage, small residual, small influence
point_2 = c(18, -5.7)
...
# Checking for high leverage, large residual, large influence
point_3 = c(14, 5.1)
...
#create a copy of the data, and modify this point to have a y value of 30
lev_ex_2 = lev_ex
lev_ex_2$y[4] = 30
lm(y ~ ., data = lev_ex_2)
...
#Outliers
#Standardized residuals can be obtained by using rstandard() 
resid(model_1)
rstandard(model_1)
...
#Checking thge influence using cooks distance
